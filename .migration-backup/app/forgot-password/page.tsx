        ...
        <div style={{ background:"var(--surface)", borderRadius:"var(--radius)", padding:"28px 24px", boxShadow:"var(--shadow-md)" }}>
          ...
          {sent ? (
            ...
            <div style={{ textAlign:"center" }}>
              ...
              <Link
                href="/login"
                style={{ display:"block", padding:"13px", borderRadius:"var(--radius-sm)", background:"var(--gradient)", color:"white", fontFamily:"var(--font-display)", fontWeight:700, fontSize:"15px", textDecoration:"none", textAlign:"center", boxShadow:"0 4px 14px rgba(45,135,200,0.3)" }}
              >
                Back to Login
              </Link>
            </div>
