      ...
      {(post.is_announcement || post.is_pinned) && (
        <div style={{ padding:"7px 16px", background: post.is_announcement ? "linear-gradient(90deg, #EBF5FF, #F0F6FA)" : "linear-gradient(90deg, #EDFFF5, #F0FAF5)", display:"flex", alignItems:"center", gap:"6px", borderBottom:`1px solid ${post.is_announcement ? "var(--blue-light)" : "var(--green-light)"}` }}>
          {post.is_announcement
            ? <Megaphone size={13} color="var(--blue)" />
            : <Pin size={13} color="var(--green)" />}
      ...
      <div style={{ display:"flex", gap:"0" }}>
        ...
        <div style={{ display:"flex", flexDirection:"column", alignItems:"center", padding:"14px 10px", gap:"4px", background:"var(--surface-2)", minWidth:"44px" }}>
          <button
            ...
            style={{ background:"none", border:"none", cursor: currentUserId ? "pointer" : "default", padding:"4px", borderRadius:"6px", display:"flex", color: userVote === "up" ? "var(--blue)" : "var(--text-light)", transition:"all 0.15s ease" }}
          >
          ...
          <button
            ...
            style={{ background:"none", border:"none", cursor: currentUserId ? "pointer" : "default", padding:"4px", borderRadius:"6px", display:"flex", color: userVote === "down" ? "#E8445A" : "var(--text-light)", transition:"all 0.15s ease" }}
          >
        ...
        <div style={{ flex:1, padding:"14px 16px", minWidth:0 }}>
          ...
          <div style={{ display:"flex", alignItems:"center", gap:"8px", marginBottom:"8px", flexWrap:"wrap" }}>
            <Link href={`/community/${post.community.slug}`} style={{ display:"flex", alignItems:"center", gap:"5px", textDecoration:"none" }}>
