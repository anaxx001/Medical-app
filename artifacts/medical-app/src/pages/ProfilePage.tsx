...
export default function ProfilePage() {
  ...
  const fetchProfile = useCallback(async () => {
    ...
    try {
      ...
      // Fetch posts with pinned_at ordering
      ...
      <AppShell>
        <div style={{ maxWidth: "900px", margin: "0 auto", padding: "20px" }}>
          <div style={{ background: "var(--surface)", border: "1px solid var(--border)", borderRadius: "var(--radius)", overflow: "hidden" }}>
            <div style={{ height: "240px", background: "var(--surface-2)" }} />
            <div style={{ padding: "20px 24px" }}>
              <div style={{ width: "120px", height: "120px", borderRadius: "50%", background: "var(--surface-2)", marginTop: "-60px", marginBottom: "16px" }} />
  ...
  if (isPrivate && !isOwn && !isFollowing && !isAdmin) {
    return (
      <AppShell>
        <div style={{ maxWidth: "900px", margin: "0 auto", padding: "20px" }}>
          <div style={{ background: "var(--surface)", border: "1px solid var(--border)", borderRadius: "var(--radius)", overflow: "hidden", textAlign: "center", padding: "48px 24px" }}>
            ...
            <button
              ...
              style={{
                ...
                background: followRequestPending ? "var(--surface-2)" : "#1ABC9C",
    ...
    <AppShell>
      <div style={{ maxWidth: "900px", margin: "0 auto", padding: "20px" }}>
        ...
        >
          ...
          >
            {/* Banner Upload Overlay (Own Profile) */}
            {isOwn && (
              <>
                <input
                  ref={bannerInputRef}
          ...
          <div style={{ padding: "0 24px 24px" }}>
              ...
              <div style={{ display: "flex", alignItems: "flex-end", gap: "16px", position: "relative" }}>
                ...
                <div style={{ paddingBottom: "8px" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                    ...
                    {profile.is_verified && (
                      <Shield size={18} color="#1ABC9C" fill="#1ABC9C" />
                    )}
                    {profile.role === "super_admin" && (
                      <Crown size={18} color="#F39C12" />
                    )}
                  </div>
                  <p
                    style={{
            ...
            >
              ...
              >
                ...
                <span style={{ fontFamily: "var(--font-body)", fontSize: "13px", color: "var(--text-muted)", marginLeft: "4px" }}>
                  Followers
                </span>
              </button>
              <button
        ...
        {isOwn && (
          ...
          >
            ...
            >
              ...
              <div>
                <div style={{ fontFamily: "var(--font-display)", fontWeight: 700, fontSize: "18px", color: "var(--text)" }}>
                  {karmaScore}
                </div>
              ...
              >
                ...
                <button
                  ...
                  style={{
                    ...
                    background: editForm.is_private ? "#1ABC9C" : "var(--surface-3)",
          ...
          {editModalTab === "blocked" && (
            <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
              {blockedUsers.length > 0 ? (
                ...
                <p style={{ textAlign: "center", color: "var(--text-muted)", fontFamily: "var(--font-body)", fontSize: "14px", padding: "20px" }}>
                  No blocked users
                </p>
              )}
            </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            ...
            <div style={{ display: "flex", justifyContent: "flex-end", gap: "10px" }}>
              ...
              <button
                ...
                style={{
                  padding: "10px 24px", borderRadius: "99px", border: "none",
                  background: reportReason.trim() ? "#E74C3C" : "var(--surface-3)",
            ...
            {violations.map((v) => (
              <div
                ...
                style={{
                  ...
                  borderRadius: "var(--radius)", border: "1px solid var(--border)", fontSize: "13px",
                }}
              >
  ...
  return (
    ...
    >
      <div
        style={{
          background: "var(--surface)", border: "1px solid var(--border)",
          borderRadius: "var(--radius)", maxWidth: "560px", width: "100%",
    ...
    <Modal onClose={onClose} title={title}>
      <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
        {loading ? (
          ...
          users.map((user) => (
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                {user.bio && (
                  <div style={{ fontFamily: "var(--font-body)", fontSize: "12px", color: "var(--text-muted)", marginTop: "2px", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                    {user.bio}
                  </div>
                )}
              </div>
          ...
          <p style={{ textAlign: "center", color: "var(--text-muted)", fontFamily: "var(--font-body)", padding: "20px" }}>
            No users found
          </p>
        )}
      </div>
