      ...
      <AppShell>
        <div style={{ maxWidth: "900px", margin: "0 auto", padding: "12px" }}>
          <div style={{ background: "var(--surface)", border: "1px solid var(--border)", borderRadius: "12px", overflow: "hidden" }}>
            <div style={{ height: "240px", background: "rgba(0,0,0,0.03)" }} />
            <div style={{ padding: "20px 24px" }}>
              <div style={{ width: "120px", height: "120px", borderRadius: "50%", background: "rgba(0,0,0,0.03)", marginTop: "-60px", marginBottom: "16px" }} />
              <div style={{ width: "200px", height: "24px", background: "rgba(0,0,0,0.03)", borderRadius: "4px", marginBottom: "8px" }} />
              <div style={{ width: "120px", height: "16px", background: "rgba(0,0,0,0.03)", borderRadius: "4px" }} />
            </div>
          </div>
        </div>
      </AppShell>
