...
export default function StartCommunityPage() {
  ...
  const validate = () => {
    ...
    if (!justification.trim()) {
      nextErrors.justification = "Please tell us why you're creating this community.";
      ...
      <div className="mx-auto max-w-3xl px-4 py-8">
        <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label className="mb-2 block text-sm font-medium text-slate-700">
                Why are you creating this community, and how will it benefit
                students?
              </label>
              ...
              <p className="mt-1 text-sm text-slate-500">
                This is only shown to admins and helps us review your request
                faster.
              </p>
