        ...
        {joinedCommunities.length > 0 && (
          <>
            ...
            {joinedCommunities.map((comm) => (
              <LinkItem
                key={comm.id}
                icon={comm.icon ? () => <img src={comm.icon} style={{ width: 20, height: 20, borderRadius: "4px" }} /> : Users}
                label={comm.name}
        ...
        {createdCommunities.length > 0 && (
          <>
            ...
            {createdCommunities.map((comm) => (
              <LinkItem
                key={comm.id}
                icon={comm.icon ? () => <img src={comm.icon} style={{ width: 20, height: 20, borderRadius: "4px" }} /> : Star}
                label={comm.name}
                path={`/community/${comm.slug}`}
              />
            ))}
